...
```
Calculate your one-rep max and plan your sets using RPE-based formulas
```
...
**Character count: ~3,100 (well under 4000 limit)**
...
### App Title Options:
1. E1RM Calculator - One Rep Max (28 chars)
2. E1RM - 1RM & Sets Planner (24 chars)
3. E1RM One Rep Max Calculator (26 chars)

### Promo Text (Optional, 170 chars max):
```
Calculate your true one-rep max and plan your full session using the RPE method. More accurate than traditional formulas. Perfect for powerlifters and strength athletes.
```
...
- No violence, mature content, or inappropriate material
- Safe for all ages
...
1. **Privacy Policy URL:** Upload PRIVACY_POLICY.md to a public URL or use GitHub raw link
2. **Screenshots:** Use the 7 screenshots captured with take-screenshots.sh
3. **Feature Graphic:** Consider creating a 1024x500px banner showing the app in use
4. **App Icon:** Already set (512x512px version may be needed for upload)
5. **Target Audience:** Adults 18+ (typical gym-goers, though app is safe for all ages)

---

## Pro Tips

- Emphasise "RPE-based" and "privacy-focused" as key differentiators
- Highlight the Sets Planner as a key differentiator from other 1RM calculators
- Mention it works offline (no internet required)
- Use keywords like "powerlifting," "strength training," "1RM", "sets planner" for better discoverability
